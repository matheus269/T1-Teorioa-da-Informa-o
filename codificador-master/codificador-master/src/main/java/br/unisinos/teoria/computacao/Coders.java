...
//            int op = JOptionPane.showOptionDialog(null, "Escolha a fun��o desejada:", "Fun��o",
...
//                        JOptionPane.showMessageDialog(null, "Decodifica��o finailzada");
//                    }
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
...
//                Object selectedValue = JOptionPane.showInputDialog(null, "Qual codifica��o deseja usar ?", "Op��es",
...
//                        String newPath = (extIndex > -1 ? filePath.substring(0, extIndex) : filePath) + ext;
//                        Files.write(Paths.get(newPath), result);
//                        JOptionPane.showMessageDialog(null, "Codifica��o finalizada");
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                    }
//                }
